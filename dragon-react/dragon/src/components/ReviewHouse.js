                                        ...
                                        <div className="content"> 
                                            <div className="_ni9axhe">
                                                <div style={{marginLeft: '16px'}}>
                                                    <div className="_1r804a6o font-size16">Suitable for children and infants</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="row service-detail">
                                    ...
                                    <div className="logo-content">
                                        <div className="content"> 
                                            <div className="_ni9axhe">
                                                <div style={{marginLeft: '16px'}}>
                                                    <div className="_1r804a6o font-size16">No pets</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="row service-detail">
                                    ...
                                    <div className="logo-content">
                                        <div className="content"> 
                                            <div className="_ni9axhe">
                                                <div style={{marginLeft: '16px'}}>
                                                    <div className="_1r804a6o font-size16">Parties and events allowed</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="row service-detail">
                                    ...
                                    <div className="logo-content">
                                        <div className="content"> 
                                            <div className="_ni9axhe">
                                                <div style={{marginLeft: '16px'}}>
                                                    <div className="_1r804a6o font-size16">Smoking allowed</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
