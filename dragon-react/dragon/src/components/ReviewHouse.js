...
class ReviewHouse extends Component {
    constructor(props) {
        ...
        this.createObjectBooking = this.createObjectBooking.bind(this);
    ...
    renderPolices(policy, index) {
        ...
        if (policy.Policy.Name.toUpperCase() === "No pets".toUpperCase()) {
                    ...
                    <div className="content">
                        <div className="_ni9axhe">
                            <div style={{ marginLeft: '16px' }}>
                                <div className="_1r804a6o font-size16">{policy.Policy.Name}</div>
                            </div>
                        </div>
                    </div>
                </div>
            </div>
        } else if (policy.Policy.Name.toUpperCase() === "Suitable for children and infants".toUpperCase()) {
            return <div className="row service-detail" key={index}>
                <div className="logo-box">
        ...
        } else if (policy.Policy.Name.toUpperCase() === "Events or parties allowed".toUpperCase()) {
            return <div className="row service-detail" key={index}>
                <div className="logo-box">
        ...
        } else if (policy.Policy.Name.toUpperCase() === "Smoking allowed".toLocaleUpperCase()) {
            return <div className="row service-detail" key={index}>
                <div className="logo-box">
